...
| V-5 | ECU Reset (`0x11`) integrated with the ECU lifecycle | Recommended next |
...
should integrate ECU Reset with the existing ECU lifecycle and diagnostic-session reset behavior.
