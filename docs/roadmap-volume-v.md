...
| V-4 | Security Access (`0x27`) with bounded seed/key attempts and lockout simulation | Recommended next |
...
V-4 should add deterministic Security Access with bounded attempts and lockout behavior.
