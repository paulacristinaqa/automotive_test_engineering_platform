...
Add coupled thermal, battery-energy, powertrain, braking, steering, suspension, and lighting
behavior around the deterministic step engine. Preserve explicit units and bounds, then verify
scenario outcomes and conservation constraints without wall-clock loops.
