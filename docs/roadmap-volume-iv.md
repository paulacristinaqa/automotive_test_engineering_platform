...
| IV-3 | DBC catalogue, signal encoding/decoding, scaling, offsets, and byte order | Planned |
...
IV-2 establishes a transparent nominal timing model without pretending to model bit stuffing,
acknowledgement, retransmission, or physical errors. The recommended next increment is IV-3.
