...
| Browser dashboard | Actual browser login/stream, origin protection, reconnect and expired-session behavior | X-7.4 login/logout/no-role shell evidence; X-7.5 real local expiry, role loss, controlled reconnect and basic keyboard passed; responsive/broader accessibility pending |
