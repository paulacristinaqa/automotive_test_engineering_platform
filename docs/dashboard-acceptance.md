...
| Browser dashboard | Actual browser login/stream, origin protection, reconnect and expired-session behavior | X-7.1 real Chromium fixture passed five protocol checks; end-user login/UI/reconnect pending |
