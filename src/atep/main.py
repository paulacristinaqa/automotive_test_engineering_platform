...
from atep.ai_engine.router import router as ai_engine_router
...
from atep.dashboard.realtime import router as dashboard_websocket_router
from atep.dashboard.router import router as dashboard_router
from atep.dashboard.ui import router as dashboard_ui_router
...
app.include_router(ai_engine_router, prefix="/api/v1", dependencies=rate_limited)
...
app.include_router(dashboard_websocket_router, prefix="/api/v1")
