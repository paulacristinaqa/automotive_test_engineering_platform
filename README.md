...
**Volume III — ECU Simulator**, and **Volume IV — CAN Network** through the structured DBC codec.
...
> **Project status:** active development. Volume III is baselined and Volume IV-3 is implemented. The first
...
| IV | CAN Network | In progress — increments IV-1 through IV-3 implemented |
