...
| X | Dashboard | In progress - X-1 through X-5 delivered (X-5 reduced scope); X-6.1–X-6.5 exports, snapshots, query verification and handshake admission implemented |
| X | Dashboard | Planned |
| XI | DevOps | Planned |
