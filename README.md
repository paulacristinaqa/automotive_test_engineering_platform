...
| X | Dashboard | In progress - X-1 through X-6 backend scope delivered (X-5 reduced scope); X-7.5 shell lifecycle/basic keyboard accepted; responsive/AAOS/deployment acceptance pending |
| X | Dashboard | Planned |
| XI | DevOps | Planned |
