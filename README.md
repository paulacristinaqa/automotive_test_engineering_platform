...
**Volume III — ECU Simulator**, and **Volume IV — CAN Network** through deterministic fault injection and bus-off recovery.
...
> **Project status:** active development. Volume III is baselined and Volume IV-5 is implemented. The first
...
The first production-hardening deployment slice separates namespace/configuration, cluster-wide
image admission, the Alembic migration Job, and application workloads into four Kustomize targets. It intentionally contains
...
| IV | CAN Network | In progress — increments IV-1 through IV-5 implemented |
...
versioned gateway catalogue now makes global, seat, and wheel property semantics explicit. Volume
III now provides the ECU aggregate, deterministic execution clock, and behavior-profile registry.
