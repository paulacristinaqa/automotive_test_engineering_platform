...
**Volume III — ECU Simulator**, and **Volume IV — CAN Network** through deterministic CAN FD timing.
...
> **Project status:** active development. Volume III is baselined and Volume IV-4 is implemented. The first
...
| IV | CAN Network | In progress — increments IV-1 through IV-4 implemented |
