...
| X | Dashboard | In progress - X-1 through X-5 delivered (X-5 reduced scope); X-6.1–X-6.6 exports, snapshots, query verification, admission and native transport boundary implemented |
| X | Dashboard | Planned |
| XI | DevOps | Planned |
