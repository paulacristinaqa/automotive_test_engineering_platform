...
| X | Dashboard | In progress - X-1 through X-6 backend scope delivered (X-5 reduced scope); opt-in browser authentication added; X-7 client/deployment acceptance pending |
| X | Dashboard | Planned |
| XI | DevOps | Planned |
