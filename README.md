...
| X | Dashboard | In progress - X-1 through X-6 backend scope delivered (X-5 reduced scope); X-7.10 native engineering panel implemented; actual AAOS/deployment acceptance pending |
| X | Dashboard | Planned |
| XI | DevOps | Planned |
